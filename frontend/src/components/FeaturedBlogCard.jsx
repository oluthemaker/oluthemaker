...
const FeaturedBlogCard = ({ post }) => {
  ...
  return (
    <div className="w-full bg-atelier-paper py-28 px-6 border-t border-atelier-ink/5">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
          {/* IMAGE BLOCK (Standardized to md:col-span-7 & aspect-[16/10]) */}
                <div className="md:col-span-7 relative aspect-[16/10] overflow-hidden group border border-atelier-ink/10 bg-atelier-ink/5">
                  <motion.img
                ...
                {/* TEXT BLOCK (Standardized to md:col-span-5) */}
